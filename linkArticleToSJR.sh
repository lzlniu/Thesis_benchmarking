...
workdir="/home/projects/ku_10024/people/zelili/tagger_test"
SJRfile="/home/projects/ku_10024/people/zelili/tagger_test/journalrank567.txt"
cd $workdir
cd xmlout
for file in $(ls new_*.tsv); do
echo "
#!/bin/bash
...
#rm -rf \$Wc
" > ${workdir}/xmlout/Wc_${file}.sh
qsub < ${workdir}/xmlout/Wc_${file}.sh
done
